...
######################BO Optimization####################
def convert_track_to_bbox_list(split_each_track,mapping_node_id_to_bbox,mapping_node_id_to_belonglings,trajectory_node_dict,trajectory_idswitch_dict,trajectory_idswitch_reliability_dict):
    ...
    return predicted_tracks_centers,predicted_tracks_bboxes,predicted_tracks_bboxes_test,delete_track,mapping_node_id_to_belonglings
...
# split_each_track,mapping_node_id_to_bbox,mapping_node_id_to_belonglings,trajectory_node_dict,trajectory_idswitch_dict
    predicted_tracks_centers,predicted_tracks_bboxes,predicted_tracks_bboxes_test,delete_track,mapping_node_id_to_belongings = convert_track_to_bbox_list(split_each_track, mapping_node_id_to_bbox,mapping_node_id_to_belongings,trajectory_node_dict,trajectory_idswitch_dict,trajectory_idswitch_reliability_dict)
