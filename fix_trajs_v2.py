...
def convert_track_to_bbox_list(split_each_track,mapping_node_id_to_bbox,mapping_node_id_to_belonglings):
    ...
    return predicted_tracks_centers,predicted_tracks_bboxes,predicted_tracks_bboxes_test,delete_track
...
def BO_fix_Thompson_sampling(result, mapping_edge_id_to_cost, mapping_node_id_to_bbox, mapping_node_id_to_features, device, source):
    ...
    predicted_tracks_centers,predicted_tracks_bboxes,predicted_tracks_bboxes_test,delete_track = convert_track_to_bbox_list(split_each_track, mapping_node_id_to_bbox,mapping_node_id_to_belongings)
